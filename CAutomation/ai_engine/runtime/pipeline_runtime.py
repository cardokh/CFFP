"""Shared runtime support for configured CAutomation AI Engine pipelines."""
...
from scripts.shared.script_console_utils import print_failed, print_passed, print_warning
from scripts.shared.script_json_utils import read_json_file, write_json_file


class ConfiguredPipelineRuntime(BaseScript):
    """Reusable orchestrator for configuration-driven CAutomation pipelines."""
