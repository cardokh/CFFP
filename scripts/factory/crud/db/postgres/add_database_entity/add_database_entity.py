"""
Adds database entities to the existing PostgreSQL metadata files.
...
def run(self) -> None:
    ...
    for entity in self.entities:
        ...
        entity_schema = self._get_required_object(entity, "schema", f"Entity '{entity_name}' must contain 'schema'.")
