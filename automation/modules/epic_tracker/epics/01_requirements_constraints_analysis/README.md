...
Collect, normalize, and validate all business, functional, non-functional, technical, environmental, and delivery constraints needed to drive the rest of the lifecycle.
...
Primary output contract: **Requirements & Constraints Package**.
...
Human clarification is expected here. Critical open questions block the pipeline.
