...
Generate backend application artifacts such as APIs, services, repositories, domain logic, authentication boundaries, configuration, and backend documentation.
...
Primary output contract: **Backend Package**.
...
Consumes database outputs and solution design to produce executable backend structure.
