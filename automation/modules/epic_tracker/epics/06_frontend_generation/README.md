...
Generate frontend artifacts such as pages, components, workflows, forms, navigation, API integration points, and frontend documentation.
...
Primary output contract: **Frontend Package**.
...
Consumes project plan, solution design, and backend contracts.
