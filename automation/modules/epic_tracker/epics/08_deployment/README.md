...
Generate deployment and release artifacts, including environment configuration, Docker assets, CI/CD workflows, release checks, and deployment documentation.
...
Primary output contract: **Deployment Package**.
...
Final lifecycle stage before delivery or release.
